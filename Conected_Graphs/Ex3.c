...
//this function checks if the graph is a tree (is connected and V-E=1)
int isTree(components, gsize, gorder){
    	if((components == 1) & (gorder-gsize==1)) return 1;
    	return 0;
...
int main(int argc,char *argv[]){
    ...
    printf("%u \n", isTree(components, gsize, gorder));
    return 0;
}